...
const ProductText = () => {
  return (
    <div>
      <Row className="mt-2">
        <div className={style["cat-text"]}>الالكترونيات :</div>
      </Row>
      <Row>
        <Col md="8">
          <div className={`${style["cat-title"]} d-inline`}>
            آيفون XR بذاكرة سعة 128 جيجابايت ويدعم تقنية 4G LTE مع تطبيق فيس تايم (برودكت) أحمر <div className="cat-rate d-inline mx-3">4.5</div>
          </div>
        </Col>
      </Row>
      <Row>
        <Col md="8" className="mt-4">
          ...
          <div className={`${style["barnd-text"]} d-inline mx-1`}>آيفون </div>
        </Col>
      </Row>
      <Row>
        <Col md="8" className="mt-1 d-flex">
          <div className={`${style["color"]} ms-2 border`} style={{ backgroundColor: "#E52C2C" }}></div>
          <div className={`${style["color"]} ms-2 border`} style={{ backgroundColor: "white" }}></div>
          <div className={`${style["color"]} ms-2 border`} style={{ backgroundColor: "black" }}></div>
        </Col>
      </Row>
