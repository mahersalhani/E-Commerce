    ...
    <div className={style["sidebar"]}>
      <div className="d-flex flex-column">
        ...
        <Link to="/admin/allproducts" style={{ textDecoration: "none" }}>
          <div className={`${style["admin-side-text"]} my-1 border-bottom p-2 mx-auto text-center`}>اداره المنتجات</div>
        </Link>
        <Link to="/admin/addbrand" style={{ textDecoration: "none" }}>
          <div className={`${style["admin-side-text"]} my-1 border-bottom p-2 mx-auto text-center`}>اضف ماركه</div>
        </Link>

        <Link to="/admin/addcategory" style={{ textDecoration: "none" }}>
          <div className={`${style["admin-side-text"]} my-1 border-bottom p-2 mx-auto text-center`}>اضف تصنيف</div>
        </Link>

        <Link to="/admin/addsubcategory" style={{ textDecoration: "none" }}>
          <div className={`${style["admin-side-text"]} my-1 border-bottom p-2 mx-auto text-center`}>اضف تصنيف فرعي</div>
        </Link>
