  ...
  return (
    <div>
      <Row className="justify-content-start ">
        ...
        <Col sm="8">
          <input type="text" className={`${style["input-form"]} d-block mt-3 px-3`} placeholder="اسم التصنيف الفرعي" />
          <select name="languages" id="lang" className={`${style["select"]} mt-3 px-2 `}>
